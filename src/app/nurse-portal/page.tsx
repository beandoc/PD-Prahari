...
// It immediately redirects them to their primary workspace, the nurse dashboard,
...
export default function NursePortalRedirect() {
  ...
  useEffect(() => {
    // Redirect to the new nurse dashboard
    router.replace('/dashboard/nurse-dashboard');
  }, [router]);
