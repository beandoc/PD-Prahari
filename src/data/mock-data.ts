...
export const allPatientData: PatientData[] = [
  {
    ...
    pdStartDate: '2024-01-20',
    pdTrainingEndDate: '2024-04-20',
    lastHomeVisitDate: '2025-05-10',
    ...
    vitals: [
      {
        vitalId: 'VIT-TODAY',
        measurementDateTime: '2025-07-29T08:00:00Z',
        systolicBP: 132,
        diastolicBP: 81,
        heartRateBPM: 74,
      ...
      {
        vitalId: 'VIT-001',
        measurementDateTime: '2025-07-28T08:00:00Z',
        systolicBP: 130,
        diastolicBP: 80,
        heartRateBPM: 75,
       ...
       {
        vitalId: 'VIT-002',
        measurementDateTime: '2025-07-27T08:00:00Z',
        systolicBP: 135,
        diastolicBP: 82,
        heartRateBPM: 72,
    ...
    labResults: [
      { labResultId: 'LAB-001', resultDateTime: '2025-07-25T09:00:00Z', testName: 'Creatinine', resultValue: 7.2, units: 'mg/dL', referenceRangeLow: 0.6, referenceRangeHigh: 1.2 },
      { labResultId: 'LAB-002', resultDateTime: '2025-07-25T09:00:00Z', testName: 'Potassium', resultValue: 4.5, units: 'mmol/L', referenceRangeLow: 3.5, referenceRangeHigh: 5.1 },
      { labResultId: 'LAB-003', resultDateTime: '2025-07-25T09:00:00Z', testName: 'Calcium', resultValue: 8.9, units: 'mg/dL', referenceRangeLow: 8.5, referenceRangeHigh: 10.2 },
      { labResultId: 'LAB-004', resultDateTime: '2025-07-25T09:00:00Z', testName: 'Phosphorus', resultValue: 5.8, units: 'mg/dL', referenceRangeLow: 2.5, referenceRangeHigh: 4.5 },
      { labResultId: 'LAB-005', resultDateTime: '2025-07-25T09:00:00Z', testName: 'Albumin', resultValue: 3.5, units: 'g/dL', referenceRangeLow: 3.4, referenceRangeHigh: 5.4 },
      { labResultId: 'LAB-006', resultDateTime: '2025-07-25T09:00:00Z', testName: 'iPTH', resultValue: 350, units: 'pg/mL', referenceRangeLow: 150, referenceRangeHigh: 300 },
      { labResultId: 'LAB-008', resultDateTime: '2025-07-25T09:00:00Z', testName: 'Hemoglobin', resultValue: 11.2, units: 'g/dL', referenceRangeLow: 13.5, referenceRangeHigh: 17.5 },
      { labResultId: 'LAB-009', resultDateTime: '2025-06-25T09:00:00Z', testName: 'Creatinine', resultValue: 7.0, units: 'mg/dL', referenceRangeLow: 0.6, referenceRangeHigh: 1.2 },
    ],
    pdEvents: [
      { exchangeId: 'PD-TODAY-1', exchangeDateTime: '2025-07-29T07:30:00Z', dialysateType: 'Dextrose 1.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2150, ultrafiltrationML: 150, recordedBy: 'Patient' },
      { exchangeId: 'PD-TODAY-2', exchangeDateTime: '2025-07-29T12:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2200, ultrafiltrationML: 200, isEffluentCloudy: false, recordedBy: 'Patient' },
      // Recent events (last 14 days) - LOW UF
      { exchangeId: 'PD-R-1', exchangeDateTime: '2025-07-28T07:00:00Z', dialysateType: 'Dextrose 1.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2050, ultrafiltrationML: 50, recordedBy: 'Patient' },
      { exchangeId: 'PD-R-2', exchangeDateTime: '2025-07-27T12:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2080, ultrafiltrationML: 80, recordedBy: 'Patient' },
      { exchangeId: 'PD-R-3', exchangeDateTime: '2025-07-26T07:00:00Z', dialysateType: 'Dextrose 1.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2060, ultrafiltrationML: 60, recordedBy: 'Patient' },

      // Historical events (>14 days ago) - HIGH UF (BASELINE)
      { exchangeId: 'PD-H-1', exchangeDateTime: '2025-07-01T07:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2300, ultrafiltrationML: 300, recordedBy: 'Patient' },
      { exchangeId: 'PD-H-2', exchangeDateTime: '2025-07-01T12:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2350, ultrafiltrationML: 350, recordedBy: 'Patient' },
      { exchangeId: 'PD-H-3', exchangeDateTime: '2025-07-02T07:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2320, ultrafiltrationML: 320, recordedBy: 'Patient' },
      { exchangeId: 'PD-H-4', exchangeDateTime: '2025-07-02T12:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2000, dwellTimeHours: 4, drainVolumeML: 2280, ultrafiltrationML: 280, recordedBy: 'Patient' },
    ],
    peritonitisEpisodes: [
    ...
    urineOutputLogs: [
      ...
      { logId: 'UO-002', logDate: '2025-07-27', volumeML: 300 },
    ],
    pdAdequacy: [
        { testId: 'KT-001', testDate: '2025-06-01', totalKtV: 1.8, peritonealKtV: 1.6, notes: 'Adequate clearance.'}
    ],
    patientReportedOutcomes: [
        { surveyId: 'PRO-001', surveyId: 'PRO-001', surveyDate: '2025-06-15', surveyTool: 'KDQOL-36', score: 78, summary: 'Patient reports good overall health but some fatigue.' }
    ],
    uploadedImages: [
        { imageId: 'IMG-001', type: 'exit-site', uploadDate: '2025-07-28T10:00:00Z', imageUrl: 'https://placehold.co/400x300.png', requiresReview: true }
    ],
    nutritionLifestyle: { 
    ...
    clinicVisits: { nextAppointment: '2025-12-15T10:00:00Z', lastVisitSummary: 'Routine follow-up. Patient doing well on current regimen. Discussed nutrition goals.', },
  ...
  },
  {
    ...
    vitals: [{ vitalId: 'VIT-003', measurementDateTime: '2025-07-28T09:00:00Z', systolicBP: 185, diastolicBP: 95, heartRateBPM: 68, temperatureCelsius: 37.0, weightKG: 80, respiratoryRateBPM: 18, fluidStatusNotes: 'Mild ankle edema' }],
    labResults: [
        { labResultId: 'LAB-003', resultDateTime: '2025-07-26T10:00:00Z', testName: 'Creatinine', resultValue: 8.1, units: 'mg/dL', referenceRangeLow: 0.7, referenceRangeHigh: 1.3 },
        { labResultId: 'LAB-007', resultDateTime: '2025-07-26T10:00:00Z', testName: 'Albumin', resultValue: 3.2, units: 'g/dL', referenceRangeLow: 3.4, referenceRangeHigh: 5.4 },
        { labResultId: 'LAB-010', resultDateTime: '2025-07-26T10:00:00Z', testName: 'Hemoglobin', resultValue: 10.5, units: 'g/dL', referenceRangeLow: 13.5, referenceRangeHigh: 17.5 },
        { labResultId: 'LAB-011', resultDateTime: '2025-07-26T10:00:00Z', testName: 'Phosphorus', resultValue: 6.1, units: 'mg/dL', referenceRangeLow: 2.5, referenceRangeHigh: 4.5 },
    ],
    pdEvents: [ 
        { exchangeId: 'PD-003', exchangeDateTime: '2025-07-20T08:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2200, dwellTimeHours: 4, drainVolumeML: 2250, ultrafiltrationML: 50, isEffluentCloudy: false, recordedBy: 'Patient' },
        { exchangeId: 'PD-004', exchangeDateTime: '2025-06-20T08:00:00Z', dialysateType: 'Dextrose 2.5%', fillVolumeML: 2200, dwellTimeHours: 4, drainVolumeML: 2150, ultrafiltrationML: -50, isEffluentCloudy: false, recordedBy: 'Patient' },
    ],
    peritonitisEpisodes: [
      { episodeId: 'PER-003', diagnosisDate: '2025-01-10', organismIsolated: 'E. coli', treatmentRegimen: 'Ciprofloxacin', outcome: 'Resolved', resolutionDate: '2025-01-24' },
      { episodeId: 'PER-004', diagnosisDate: '2024-09-05', organismIsolated: 'S. Aureus', treatmentRegimen: 'Cefazolin + Ceftazidime', outcome: 'Catheter Removal', resolutionDate: '2024-09-20' }
    ],
    medications: [{ medicationId: 'MED-003', medicationName: 'Amlodipine', dosage: '5mg', frequency: 'Once daily', startDate: '2023-06-15', prescribingDoctor: 'Dr. Atul', status: 'ok' }],
    urineOutputLogs: [{ logId: 'UO-003', logDate: '2025-07-28', volumeML: 150 }],
    pdAdequacy: [{ testId: 'KT-002', testDate: '2025-07-01', totalKtV: 1.6, peritonealKtV: 1.5, notes: 'Borderline adequate.'}],
    patientReportedOutcomes: [{ surveyId: 'PRO-002', surveyId: 'PRO-002', surveyDate: '2025-07-01', surveyTool: 'KDQOL-36', score: 65, summary: 'Patient reports feeling well but has concerns about fluid retention.' }],
    ...
    clinicVisits: { nextAppointment: '2025-08-01T11:00:00Z', lastVisitSummary: 'Blood pressure slightly elevated. Continue monitoring.' },
  ...
  },
  {
    ...
    stateProvince: 'Maharashtra',
    postalCode: '440001',
    pdStartDate: '2025-07-01', // In training
    pdTrainingEndDate: '2025-09-30', // In training
    pdExchangeType: 'Self',
    ...
    vitals: [
        { vitalId: 'VIT-004', measurementDateTime: '2025-07-28T07:30:00Z', systolicBP: 125, diastolicBP: 78, heartRateBPM: 80, temperatureCelsius: 36.7, weightKG: 68, respiratoryRateBPM: 16, fluidStatusNotes: 'No edema' },
    ],
    labResults: [
        { labResultId: 'LAB-004', resultDateTime: '2025-07-24T08:00:00Z', testName: 'Hemoglobin', resultValue: 9.8, units: 'g/dL', referenceRangeLow: 12.0, referenceRangeHigh: 15.5 },
    ],
    pdEvents: [
        { exchangeId: 'PD-005', exchangeDateTime: '2025-07-28T06:00:00Z', dialysateType: 'Dextrose 1.5%', fillVolumeML: 1800, dwellTimeHours: 4, drainVolumeML: 1900, ultrafiltrationML: 100, isEffluentCloudy: true, recordedBy: 'Patient' }
    ],
    peritonitisEpisodes: [
      { episodeId: 'PER-002', diagnosisDate: '2025-07-29', organismIsolated: 'Pseudomonas aeruginosa', treatmentRegimen: 'Ceftazidime IP', outcome: 'In Treatment' }
    ],
    medications: [{ medicationId: 'MED-004', medicationName: 'Erythropoietin', dosage: '4000 units', frequency: 'Weekly', startDate: '2025-03-01', prescribingDoctor: 'Dr. Parikshit', status: 'warning' }],
    urineOutputLogs: [{ logId: 'UO-004', logDate: '2025-07-28', volumeML: 700 }],
  ...
  },
  {
    ...
    stateProvince: 'Maharashtra',
    postalCode: '411014',
    pdStartDate: '2025-06-25', // In training (last 90 days)
    pdExchangeType: 'Self',
    ...
    clinicVisits: { nextAppointment: '2025-08-15T14:00:00Z', lastVisitSummary: 'Initial PD training completed.' },
    patientEducation: []
  },
  {
    patientId: 'PAT-005',
